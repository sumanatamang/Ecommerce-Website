		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-heading"><h3>Customer Order Details</h3></div>
							...
							if(mysqli_num_rows($query) > 0){
								while($row = mysqli_fetch_array($query)){
									...
									<div class="row" style="margin-bottom:20px;">
										<div class="col-md-6">
											<img src="product_images/<?php echo $row['product_image']; ?>" class="img-responsive img-thumbnail" style="float:right;"/>
										</div>
										<div class="col-md-6">
											<table>
